		...
		<div className="about-company">
			<div className="about-company__column el-1">
				<div className="about-company__body">
					<div className="about-company__title">ABOUT OUR STUDIO</div>
				...
				<div className='about-company__footer'>
					<a className='about-company__button' href={getPath('pages/about-company.html')}>Read more</a>
				</div>
			</div>
			<div className="about-company__column el-2">
				<div className='about-company__body'>
					<div className="about-company__title">SERVICES</div>
				...
				<div className='about-company__footer'>
					<a className='about-company__button' href="#" type='button'>Read more</a>
				</div>
			</div>
			<div className="about-company__column el-3">
				<div className='about-company__body'>
					<div className="about-company__title">OUR TEAM</div>
